...
class Register extends React.Component {
        ...
        <div className="svgContainer">
            <div>
                ...
                <g className="mouth">
                    ...
                    <path style={style}className="mouthLargeBG" d="M100 110.2c-9 0-16.2-7.3-16.2-16.2 0-2.3 1.9-4.2 4.2-4.2h24c2.3 0 4.2 1.9 4.2 4.2 0 9-7.2 16.2-16.2 16.2z" fill="#617e92" stroke="#3a5e77" stroke-linejoin="round" stroke-width="2.5"/>
                    <defs>
    ...
    <div className="inputGroup inputGroup1">
        ...
        <input type="text" id="email" className="email"  type="text" 
                                    name="email" required
                                    value={this.state.registerData.email}
                                    onChange={this.handleChange}
                                    onSubmit={this.validateEmail}
                                     maxlength="256" placeholder="Enter Email"/>
                                      <div>{!this.validateEmail(this.state.registerData.email) ? <div>Invalid Email</div>  : null } </div>
                                </div>
